(function () {
  ...
  function add_css$3() {
  	var style = element("style");
  	style.id = "svelte-15jahki-style";
  	style.textContent = ".artjam-gallery-container.svelte-15jahki{display:grid;grid-template-columns:49vw 49vw;margin:0 auto;width:100%;position:relative}.artjam-entry.svelte-15jahki{display:flex;width:100%;height:20vh;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto;position:relative}.artjam-vote.svelte-15jahki{position:absolute;bottom:1rem;right:1rem;width:2rem;height:2rem;background:rgba(255, 255, 255, 0.75)}@media all and (min-width: 960px){.artjam-gallery-container.svelte-15jahki{grid-template-columns:repeat(4, 23vw);grid-column-gap:1vw;max-width:960px}.artjam-entry.svelte-15jahki{max-width:23vw}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(70:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (71:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t2 = space();
  			attr_dev(button0, "class", "artjam-vote svelte-15jahki");
  			add_location(button0, file$3, 74, 8, 1623);
  			attr_dev(button1, "class", "artjam-entry svelte-15jahki");
  			add_location(button1, file$3, 71, 6, 1526);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(71:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$3(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t = space();
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-15jahki");
  			add_location(div, file$3, 67, 0, 1385);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-15jahki-style")) add_css$3();
