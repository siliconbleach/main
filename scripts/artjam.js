(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-t3jzpv-style";
  	style.textContent = ".gallery-lightbox-overlay.svelte-t3jzpv{position:fixed;top:0;left:0;width:100vw;height:100vw;z-index:9999;background:rgba(0, 0, 0, 0.75);opacity:0;visibility:hidden;transition:all 0.75s ease-in-out;display:flex;justify-content:center;align-items:center}.gallery-lightbox-overlay.is-open.svelte-t3jzpv{opacity:1;visibility:visible}.gallery-lightbox.svelte-t3jzpv{width:50vw;margin:0;display:flex;positon:absolute}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			img = element("img");
  			attr_dev(div0, "class", "gallery-lightbox-overlay svelte-t3jzpv");
  			toggle_class(div0, "is-open", /*lightBoxOpen*/ ctx[1]);
  			add_location(div0, file$2, 45, 0, 820);
  			if (img.src !== (img_src_value = /*activeImg*/ ctx[0] && /*activeImg*/ ctx[0].src)) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "alt", "Text for the alt tag");
  			add_location(img, file$2, 48, 4, 980);
  			add_location(picture, file$2, 47, 2, 966);
  			attr_dev(div1, "class", "gallery-lightbox svelte-t3jzpv");
  			add_location(div1, file$2, 46, 0, 890);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div1, "lightbox-select", /*selectLightboxPicture*/ ctx[2], false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  			...
  			if (dirty & /*activeImg*/ 1 && img.src !== (img_src_value = /*activeImg*/ ctx[0] && /*activeImg*/ ctx[0].src)) {
  				attr_dev(img, "src", img_src_value);
  			}
  		},
  		i: noop,
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	let { activeImg = null } = $$props;

  	const selectLightboxPicture = event => {
  		const { detail: { entry } } = event;
  		console.log("Insight Select lightbox picture");
  		$$invalidate(0, activeImg = entry);
  		debugger;
  	};

  	const writable_props = ["activeImg"];

  	Object.keys($$props).forEach(key => {
  		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<GalleryLightbox> was created with unknown prop '${key}'`);
  	});
  	...
  	$$self.$$set = $$props => {
  		if ("activeImg" in $$props) $$invalidate(0, activeImg = $$props.activeImg);
  	};

  	$$self.$capture_state = () => ({
  		activeImg,
  		selectLightboxPicture,
  		lightBoxOpen
  	});
  	...
  	$$self.$$.update = () => {
  		if ($$self.$$.dirty & /*activeImg*/ 1) {
  			 $$invalidate(1, lightBoxOpen = !!activeImg);
  		}
  	};

  	return [activeImg, lightBoxOpen, selectLightboxPicture];
  }

  class GalleryLightbox extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-t3jzpv-style")) add_css$2();
  		init(this, options, instance$2, create_fragment$2, safe_not_equal, { activeImg: 0 });
  ...
  function add_css$3() {
  	var style = element("style");
  	style.id = "svelte-1tekjvl-style";
  	style.textContent = ".artjam-gallery-container.svelte-1tekjvl{display:grid;grid-template-columns:49vw 49vw;margin:0 auto;width:100%;position:relative}.artjam-entry.svelte-1tekjvl{display:flex;width:100%;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}@media all and (min-width: 960px){.artjam-gallery-container.svelte-1tekjvl{grid-template-columns:repeat(4, 23vw);grid-column-gap:1vw;max-width:960px}.artjam-entry.svelte-1tekjvl{max-width:23vw}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	const block = {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*selectLightboxPicture, contest*/ 3) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(56:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (57:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	let button;
  	let t0_value = /*entry*/ ctx[6].name + "";
  	let t0;
  	let t1;
  	let mounted;
  	let dispose;
  	...
  	function click_handler(...args) {
  		return /*click_handler*/ ctx[2](/*entry*/ ctx[6], ...args);
  	}
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			attr_dev(button, "class", "artjam-entry svelte-1tekjvl");
  			add_location(button, file$3, 57, 6, 1251);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (dirty & /*contest*/ 1 && t0_value !== (t0_value = /*entry*/ ctx[6].name + "")) set_data_dev(t0, t0_value);
  		},
  		d: function destroy(detaching) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(57:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$3(ctx) {
  	...
  	let t;
  	let current;
  	gallerylightbox = new GalleryLightbox({ $$inline: true });
  	...
  	const block = {
  		c: function create() {
  			...
  			t = space();
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-1tekjvl");
  			add_location(div, file$3, 53, 0, 1123);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function instance$3($$self, $$props, $$invalidate) {
  	...
  	const click_handler = entry => selectLightboxPicture(entry);
  	...
  	return [contest, selectLightboxPicture, click_handler];
  }

  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1tekjvl-style")) add_css$3();
