(function () {
  ...
  function add_css$1() {
  	...
  	style.textContent = ".vote-container.svelte-66ywdh.svelte-66ywdh{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-66ywdh.svelte-66ywdh{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-66ywdh.svelte-66ywdh{flex-direction:column}.vote-holder.svelte-66ywdh.svelte-66ywdh{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-66ywdh img.svelte-66ywdh{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-66ywdh.svelte-66ywdh:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 78, 6, 1550);
  		},
  		m: function mount(target, anchor) {
  ...
  // (71:4) {#each currentVotes as vote}
  function create_each_block(ctx) {
  	let div;
  	let t0_value = /*vote*/ ctx[7]?.piece_id + "";
  	let t0;
  	let t1;
  	let img;
  	let img_src_value;
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$1, 73, 8, 1412);
  			attr_dev(div, "class", "vote-holder svelte-66ywdh");
  			add_location(div, file$1, 71, 6, 1326);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(71:4) {#each currentVotes as vote}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 67, 0, 1236);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function add_css$2() {
  	...
  	style.textContent = ".artjam-gallery-container.svelte-1stxss0{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;max-width:960px}.artjam-entry.svelte-1stxss0{width:100%;max-width:23vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  // (36:2) {#each contest?.entries as entry}
  function create_each_block$1(ctx) {
  	let button;
  	let t0_value = /*entry*/ ctx[2].name + "";
  	let t0;
  	let t1;
  	let mounted;
  	let dispose;
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(button, file$2, 36, 4, 699);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(
  					...
  					"click",
  					function () {
  						if (is_function(/*toggleVote*/ ctx[1](/*entry*/ ctx[2]))) /*toggleVote*/ ctx[1](/*entry*/ ctx[2]).apply(this, arguments);
  					},
  					false,
  					false,
  					false
  		...
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (dirty & /*contest*/ 1 && t0_value !== (t0_value = /*entry*/ ctx[2].name + "")) set_data_dev(t0, t0_value);
  		},
  		d: function destroy(detaching) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(36:2) {#each contest?.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$2, 34, 0, 620);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
