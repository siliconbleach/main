(function () {
  ...
  function create_each_block(ctx) {
  	let div;
  	let span;
  	let t0_value = /*vote*/ ctx[2].piece_id + "";
  	let t0;
  	let t1;
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			add_location(span, file, 36, 6, 545);
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*votes*/ 1 && t0_value !== (t0_value = /*vote*/ ctx[2].piece_id + "")) set_data_dev(t0, t0_value);
  		},
