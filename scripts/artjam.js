(function () {
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 79, 6, 1621);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$1, 73, 10, 1464);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 71, 6, 1382);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "click", /*clearVote*/ ctx[1](/*vote*/ ctx[9]), false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (/*vote*/ ctx[9]) if_block.p(ctx, dirty);
  		},
  		d: function destroy(detaching) {
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "votetoggle", /*votetoggle_handler*/ ctx[4], false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	function votetoggle_handler(event) {
  		bubble($$self, event);
  	}
  	...
  	$$self.$inject_state = $$new_props => {
  		...
  		if ("votes" in $$props) $$invalidate(5, votes = $$new_props.votes);
  		if ("offset" in $$props) $$invalidate(6, offset = $$new_props.offset);
  	};
  	...
  	$$self.$$.update = () => {
  		 $$invalidate(5, votes = $$props.user.votes);

  		if ($$self.$$.dirty & /*votes*/ 32) {
  			 $$invalidate(6, offset = Array(20 - votes.length));
  		}
  	...
  	return [currentVotes, clearVote, user, handleToggle, votetoggle_handler];
  }
