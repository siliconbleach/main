(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-ox2w68-style";
  	style.textContent = ".artjam-gallery-container.svelte-ox2w68{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;margin:0 auto;width:100%}.artjam-entry.svelte-ox2w68{display:flex;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}@media all and (min-width: 960px){.artjam-gallery-container.svelte-ox2w68{max-width:960px}.artjam-entry.svelte-ox2w68{max-width:23vw;width:100%}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(48:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (49:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			attr_dev(button, "class", "artjam-entry svelte-ox2w68");
  			add_location(button, file$2, 49, 6, 973);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(49:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			div = element("div");
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-ox2w68");
  			add_location(div, file$2, 46, 0, 867);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-ox2w68-style")) add_css$2();
