(function () {
  ...
  function add_css$1() {
  	...
  	style.textContent = ".vote-container.svelte-66ywdh.svelte-66ywdh{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-66ywdh.svelte-66ywdh{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-66ywdh.svelte-66ywdh{flex-direction:column}.vote-holder.svelte-66ywdh.svelte-66ywdh{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-66ywdh img.svelte-66ywdh{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-66ywdh.svelte-66ywdh:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*clearVote, currentVotes, CDN_BASE_URL*/ 6) {
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 79, 6, 1636);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$1, 73, 10, 1479);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 71, 6, 1397);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "click", /*clearVote*/ ctx[2](/*vote*/ ctx[8]), false, false, false);
  				mounted = true;
  			}
  		},
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 68, 0, 1279);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "votetoggle", /*handleToggle*/ ctx[0], false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  			if (/*currentVotes*/ ctx[1]) if_block.p(ctx, dirty);
  		},
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	$$self.$inject_state = $$new_props => {
  		...
  		if ("currentVotes" in $$props) $$invalidate(1, currentVotes = $$new_props.currentVotes);
  	...
  	return [handleToggle, currentVotes, clearVote, user];
  }
  ...
  class VoteManager extends SvelteComponentDev {
  	constructor(options) {
  		...
  		init(this, options, instance$1, create_fragment$1, safe_not_equal, { user: 3, handleToggle: 0 });
  ...
  function add_css$2() {
  	...
  	style.textContent = ".artjam-gallery-container.svelte-1stxss0{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;max-width:960px}.artjam-entry.svelte-1stxss0{width:100%;max-width:23vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  // (37:2) {#each contest?.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	function click_handler(...args) {
  		return /*click_handler*/ ctx[2](/*entry*/ ctx[4], ...args);
  	}
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(button, file$2, 37, 4, 782);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (dirty & /*contest*/ 1 && t0_value !== (t0_value = /*entry*/ ctx[4].name + "")) set_data_dev(t0, t0_value);
  		},
  		d: function destroy(detaching) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(37:2) {#each contest?.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$2, 35, 0, 703);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	...
  	Object.keys($$props).forEach(key => {
  		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<ContestGallery> was created with unknown prop '${key}'`);
  	});
