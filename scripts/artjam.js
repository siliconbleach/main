(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-uz7lsx-style";
  	style.textContent = ".gallery-lightbox-overlay.svelte-uz7lsx{position:fixed;top:0;left:0;width:100vw;height:100vw;z-index:9999;background:rgba(0, 0, 0, 0.75);opacity:0;visibility:hidden;transition:all 0.75s ease-in-out}.gallery-lightbox-overlay.is-open.svelte-uz7lsx{opacity:1;visibility:visible}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			img = element("img");
  			attr_dev(div0, "class", "gallery-lightbox-overlay svelte-uz7lsx");
  			toggle_class(div0, "is-open", /*lightBoxOpen*/ ctx[1]);
  			add_location(div0, file$2, 35, 0, 595);
  			...
  			add_location(img, file$2, 38, 4, 755);
  			add_location(picture, file$2, 37, 2, 741);
  			attr_dev(div1, "class", "gallery-lightbox");
  			add_location(div1, file$2, 36, 0, 665);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class GalleryLightbox extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-uz7lsx-style")) add_css$2();
