(function () {
  ...
  function add_css$1() {
  	var style = element("style");
  	style.id = "svelte-9gund7-style";
  	style.textContent = ".vote-container.svelte-9gund7.svelte-9gund7{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row;z-index:10000}.vote-holder.svelte-9gund7.svelte-9gund7{width:64px;height:64px;border:2px solid #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-9gund7.svelte-9gund7{flex-direction:column-reverse}.vote-holder.svelte-9gund7.svelte-9gund7{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-9gund7 img.svelte-9gund7{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-9gund7.svelte-9gund7:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 85, 11, 1694);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(img, "class", "svelte-9gund7");
  			add_location(img, file$1, 80, 10, 1544);
  		},
  		m: function mount(target, anchor) {
  ...
  // (78:4) {#each currentVotes as vote, index}
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t = space();
  			attr_dev(div, "class", "vote-holder svelte-9gund7");
  			add_location(div, file$1, 78, 6, 1455);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(78:4) {#each currentVotes as vote, index}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "vote-container svelte-9gund7");
  			add_location(div, file$1, 75, 0, 1359);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class VoteManager extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-9gund7-style")) add_css$1();
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-1v879sg-style";
  	style.textContent = ".gallery-lightbox-overlay.svelte-1v879sg{position:fixed;top:0;left:0;width:100vw;height:100vw;z-index:9999;background:rgba(0, 0, 0, 0.75);opacity:0;visibility:hidden;transition:all 0.75s ease-in-out;display:flex;justify-content:center;align-items:center}.gallery-lightbox-overlay.is-open.svelte-1v879sg{opacity:1;visibility:visible}.gallery-lightbox.svelte-1v879sg{width:50vw;margin:0 auto;display:flex;position:absolute;z-index:10000;top:25%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			img = element("img");
  			attr_dev(div0, "class", "gallery-lightbox-overlay svelte-1v879sg");
  			toggle_class(div0, "is-open", /*lightBoxOpen*/ ctx[1]);
  			add_location(div0, file$2, 50, 0, 950);
  			...
  			add_location(img, file$2, 53, 4, 1067);
  			add_location(picture, file$2, 52, 2, 1053);
  			attr_dev(div1, "class", "gallery-lightbox svelte-1v879sg");
  			add_location(div1, file$2, 51, 0, 1020);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class GalleryLightbox extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1v879sg-style")) add_css$2();
  ...
  function add_css$3() {
  	var style = element("style");
  	style.id = "svelte-1nti55t-style";
  	style.textContent = ".artjam-gallery-container.svelte-1nti55t{display:grid;grid-template-columns:49vw 49vw;margin:0 auto;width:100%;position:relative}.artjam-entry.svelte-1nti55t{display:flex;width:100%;height:20vh;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto;position:relative}.artjam-vote.svelte-1nti55t{position:absolute;bottom:1rem;right:1rem;width:2rem;height:2rem;background:rgba(255, 255, 255, 0.75);border:none}@media all and (min-width: 960px){.artjam-gallery-container.svelte-1nti55t{grid-template-columns:repeat(4, 23vw);grid-column-gap:1vw;max-width:960px}.artjam-entry.svelte-1nti55t{max-width:23vw}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(71:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (72:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t3 = space();
  			attr_dev(button0, "class", "artjam-vote svelte-1nti55t");
  			add_location(button0, file$3, 75, 8, 1641);
  			attr_dev(button1, "class", "artjam-entry svelte-1nti55t");
  			add_location(button1, file$3, 72, 6, 1544);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(72:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$3(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t = space();
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-1nti55t");
  			add_location(div, file$3, 68, 0, 1403);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1nti55t-style")) add_css$3();
