  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			add_location(span, file, 52, 6, 862);
  			attr_dev(div, "class", "vote-holder svelte-1j3wdui");
  			add_location(div, file, 51, 4, 830);
  		},
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file, 49, 0, 773);
  		},
