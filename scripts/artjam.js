(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-l4cl81-style";
  	style.textContent = ".artjam-gallery-container.svelte-l4cl81{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;margin:0 auto;width:100%}.artjam-entry.svelte-l4cl81{display:flex;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}@media all and (min-width: 960px){.artjam-gallery-container.svelte-l4cl81{max-width:960px}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			attr_dev(button, "class", "artjam-entry svelte-l4cl81");
  			add_location(button, file$2, 44, 6, 904);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			div = element("div");
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-l4cl81");
  			add_location(div, file$2, 41, 0, 798);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-l4cl81-style")) add_css$2();
