(function () {
  ...
  function add_css$2() {
  	...
  	style.textContent = ".gallery-lightbox-overlay.svelte-1v879sg{position:fixed;top:0;left:0;width:100vw;height:100vw;z-index:9999;background:rgba(0, 0, 0, 0.75);opacity:0;visibility:hidden;transition:all 0.75s ease-in-out;display:flex;justify-content:center;align-items:center}.gallery-lightbox-overlay.is-open.svelte-1v879sg{opacity:1;visibility:visible}.gallery-lightbox.svelte-1v879sg{width:50vw;margin:0 auto;display:flex;position:absolute;z-index:10000;top:25%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div0, file$2, 47, 0, 850);
  			...
  			add_location(img, file$2, 53, 4, 1008);
  			add_location(picture, file$2, 52, 2, 994);
  			attr_dev(div1, "class", "gallery-lightbox svelte-1v879sg");
  			add_location(div1, file$2, 51, 0, 961);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div0, "keyup", /*keyup_handler*/ ctx[3], false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	...
  	const keyup_handler = () => closeOverlayByKey;
  	...
  	return [activeItem, lightBoxOpen, closeOverlayByKey, keyup_handler];
  }
