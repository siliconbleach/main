  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "votetoggle", toggleVote$1, false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
