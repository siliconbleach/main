(function () {
  ...
  function add_css$1() {
  	...
  	style.textContent = ".vote-container.svelte-66ywdh.svelte-66ywdh{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-66ywdh.svelte-66ywdh{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-66ywdh.svelte-66ywdh{flex-direction:column}.vote-holder.svelte-66ywdh.svelte-66ywdh{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-66ywdh img.svelte-66ywdh{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-66ywdh.svelte-66ywdh:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 85, 6, 1742);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			img = element("img");
  			if (img.src !== (img_src_value = `${CDN_BASE_URL}/${/*vote*/ ctx[8]?.piece_id}.jpg`)) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "alt", "Artjam entry vote thumbnail");
  			attr_dev(img, "class", "svelte-66ywdh");
  			add_location(img, file$1, 79, 10, 1585);
  		},
  		m: function mount(target, anchor) {
  ...
  // (77:4) {#each currentVotes as vote}
  function create_each_block(ctx) {
  	let div;
  	let t;
  	let mounted;
  	let dispose;
  	let if_block = /*vote*/ ctx[8] && create_if_block_1(ctx);
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 77, 6, 1503);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "click", /*clearVote*/ ctx[1](/*vote*/ ctx[8]), false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (/*vote*/ ctx[8]) if_block.p(ctx, dirty);
  		},
  		d: function destroy(detaching) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(77:4) {#each currentVotes as vote}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 74, 0, 1385);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "votetoggle", /*handleToggle*/ ctx[2], false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	$$self.$inject_state = $$new_props => {
  		...
  		if ("votes" in $$props) $$invalidate(4, votes = $$new_props.votes);
  	...
  	$$self.$$.update = () => {
  		 $$invalidate(4, votes = $$props.user.votes);

  		if ($$self.$$.dirty & /*votes*/ 16) {
  			 $$invalidate(5, offset = Array(20 - votes.length));
  		}
  	...
  	return [currentVotes, clearVote, handleToggle, user];
  }
  ...
  class VoteManager extends SvelteComponentDev {
  	constructor(options) {
  		...
  		init(this, options, instance$1, create_fragment$1, safe_not_equal, { user: 3 });
  ...
  function add_css$2() {
  	...
  	style.textContent = ".artjam-gallery-container.svelte-1stxss0{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;max-width:960px}.artjam-entry.svelte-1stxss0{width:100%;max-width:23vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_each_block$1(ctx) {
  	...
  	function click_handler(...args) {
  		return /*click_handler*/ ctx[1](/*entry*/ ctx[5], ...args);
  	}
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(button, file$2, 40, 4, 843);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$2, 38, 0, 764);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
