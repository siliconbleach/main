(function () {
  ...
  function add_css$1() {
  	var style = element("style");
  	style.id = "svelte-1mftoz3-style";
  	style.textContent = ".vote-container.svelte-1mftoz3.svelte-1mftoz3{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-1mftoz3.svelte-1mftoz3{width:64px;height:64px;border:2px solid #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-1mftoz3.svelte-1mftoz3{flex-direction:column}.vote-holder.svelte-1mftoz3.svelte-1mftoz3{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-1mftoz3 img.svelte-1mftoz3{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-1mftoz3.svelte-1mftoz3:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 81, 6, 1600);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			img = element("img");
  			if (img.src !== (img_src_value = `${CDN_BASE_URL}/${/*vote*/ ctx[6]?.piece_id}.jpg`)) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "alt", "Artjam entry vote thumbnail");
  			attr_dev(img, "class", "svelte-1mftoz3");
  			add_location(img, file$1, 75, 10, 1443);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, img, anchor);
  		},
  		p: function update(ctx, dirty) {
  			if (dirty & /*currentVotes*/ 1 && img.src !== (img_src_value = `${CDN_BASE_URL}/${/*vote*/ ctx[6]?.piece_id}.jpg`)) {
  ...
  // (73:4) {#each currentVotes as vote}
  function create_each_block(ctx) {
  	let div;
  	let t;
  	let mounted;
  	let dispose;
  	let if_block = /*vote*/ ctx[6] && create_if_block_1(ctx);
  	...
  	const block = {
  		c: function create() {
  			...
  			t = space();
  			attr_dev(div, "class", "vote-holder svelte-1mftoz3");
  			add_location(div, file$1, 73, 6, 1361);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(
  					...
  					"click",
  					function () {
  						if (is_function(/*clearVote*/ ctx[1](/*vote*/ ctx[6]))) /*clearVote*/ ctx[1](/*vote*/ ctx[6]).apply(this, arguments);
  					},
  					false,
  					false,
  					false
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(73:4) {#each currentVotes as vote}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "vote-container svelte-1mftoz3");
  			add_location(div, file$1, 70, 0, 1245);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "togglevote", toggleVote$1, false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  class VoteManager extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1mftoz3-style")) add_css$1();
  ...
  function add_css$2() {
  	...
  	style.textContent = ".artjam-gallery-container.svelte-1stxss0{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;max-width:960px}.artjam-entry.svelte-1stxss0{width:100%;max-width:23vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(38:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (39:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(button, file$2, 39, 6, 793);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(39:4) {#each contest.entries as entry}",
  		ctx
  	});
