(function () {
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$2, 53, 4, 998);
  			add_location(picture, file$2, 52, 2, 984);
  			attr_dev(div1, "class", "gallery-lightbox svelte-1v879sg");
  			add_location(div1, file$2, 51, 0, 951);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div0, "keyup", /*toggleOverlay*/ ctx[2], false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	...
  	return [activeItem, lightBoxOpen, toggleOverlay];
  }
