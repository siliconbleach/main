(function () {
  ...
  function add_css() {
  	...
  	style.textContent = ".vote-container.svelte-1j3wdui{display:flex;position:fixed;bottom:8px;left:8px}.vote-holder.svelte-1j3wdui{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-1j3wdui{flex-direction:column}.vote-holder.svelte-1j3wdui{margin:8px auto}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			add_location(span, file, 47, 6, 763);
  			attr_dev(div, "class", "vote-holder svelte-1j3wdui");
  			add_location(div, file, 46, 4, 731);
  		},
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*user*/ 1 && t0_value !== (t0_value = /*vote*/ ctx[4].piece_id + "")) set_data_dev(t0, t0_value);
  		},
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(46:2) {#each user.votes as vote}",
  		ctx
  	});
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file, 44, 0, 669);
  		},
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	$$self.$inject_state = $$props => {
  		if ("user" in $$props) $$invalidate(0, user = $$props.user);
  		if ("votes" in $$props) $$invalidate(1, votes = $$props.votes);
  		if ("userVotes" in $$props) userVotes = $$props.userVotes;
  	};
