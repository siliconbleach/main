(function () {
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 77, 6, 1473);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$1, 71, 10, 1316);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, img, anchor);
  		},
  		p: function update(ctx, dirty) {
  			if (dirty & /*votes*/ 1 && img.src !== (img_src_value = `${CDN_BASE_URL}/${/*vote*/ ctx[6]?.piece_id}.jpg`)) {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 69, 6, 1234);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(69:4) {#each votes as vote}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	let current;
  	let if_block = /*votes*/ ctx[0] && create_if_block(ctx);
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	$$self.$inject_state = $$props => {
  		...
  		if ("currentVotes" in $$props) currentVotes = $$props.currentVotes;
  	};
