(function () {
  ...
  function add_css$1() {
  	var style = element("style");
  	style.id = "svelte-1l6e5n6-style";
  	style.textContent = ".vote-container.svelte-1l6e5n6{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-1l6e5n6{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-1l6e5n6{flex-direction:column}.vote-holder.svelte-1l6e5n6{margin:8px auto}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			span = element("span");
  			t = text(t_value);
  			attr_dev(span, "class", "vote-holder svelte-1l6e5n6");
  			add_location(span, file$1, 47, 3, 744);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "vote-container svelte-1l6e5n6");
  			add_location(div, file$1, 45, 0, 688);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class VoteManager extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1l6e5n6-style")) add_css$1();
