(function () {
  ...
  function add_css() {
  	...
  	style.id = "svelte-109pmw2-style";
  	style.textContent = ".vote-container.svelte-109pmw2{display:flex;position:fixed;bottom:8px;left:8px}.vote-holder.svelte-109pmw2{width:34px;height:34px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-109pmw2{flex-direction:column}.vote-holder.svelte-109pmw2{margin:8px auto}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span0, file, 34, 4, 497);
  			attr_dev(div0, "class", "vote-holder svelte-109pmw2");
  			add_location(div0, file, 33, 2, 467);
  			add_location(span1, file, 37, 4, 562);
  			attr_dev(div1, "class", "vote-holder svelte-109pmw2");
  			add_location(div1, file, 36, 2, 532);
  			add_location(span2, file, 40, 4, 627);
  			attr_dev(div2, "class", "vote-holder svelte-109pmw2");
  			add_location(div2, file, 39, 2, 597);
  			add_location(span3, file, 43, 4, 692);
  			attr_dev(div3, "class", "vote-holder svelte-109pmw2");
  			add_location(div3, file, 42, 2, 662);
  			add_location(span4, file, 46, 4, 757);
  			attr_dev(div4, "class", "vote-holder svelte-109pmw2");
  			add_location(div4, file, 45, 2, 727);
  			attr_dev(div5, "class", "vote-container svelte-109pmw2");
  			add_location(div5, file, 32, 0, 436);
  		},
  ...
  class App extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-109pmw2-style")) add_css();
