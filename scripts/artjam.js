(function () {
  ...
  function add_css$3() {
  	...
  	style.textContent = ".artjam-gallery-container.svelte-1tekjvl{display:grid;grid-template-columns:49vw 49vw;margin:0 auto;width:100%;position:relative}.artjam-entry.svelte-1tekjvl{display:flex;width:100%;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}@media all and (min-width: 960px){.artjam-gallery-container.svelte-1tekjvl{grid-template-columns:repeat(4, 23vw);grid-column-gap:1vw;max-width:960px}.artjam-entry.svelte-1tekjvl{max-width:23vw}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	const block = {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*activateItem, contest*/ 3) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(55:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (56:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	let button;
  	let t0_value = /*entry*/ ctx[7].name + "";
  	let t0;
  	let t1;
  	let mounted;
  	let dispose;
  	...
  	function click_handler(...args) {
  		return /*click_handler*/ ctx[2](/*entry*/ ctx[7], ...args);
  	}
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(button, file$3, 56, 6, 1188);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (dirty & /*contest*/ 1 && t0_value !== (t0_value = /*entry*/ ctx[7].name + "")) set_data_dev(t0, t0_value);
  		},
  		d: function destroy(detaching) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(56:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$3(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$3, 52, 0, 1060);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function instance$3($$self, $$props, $$invalidate) {
  	...
  	const click_handler = entry => activateItem(entry);
  	...
  	$$self.$inject_state = $$new_props => {
  		...
  		if ("activeItem" in $$props) activeItem = $$new_props.activeItem;
  	};
  	...
  	return [contest, activateItem, click_handler];
  }
