(function () {
  ...
  function add_css$1() {
  	...
  	style.textContent = ".vote-container.svelte-1mftoz3.svelte-1mftoz3{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-1mftoz3.svelte-1mftoz3{width:64px;height:64px;border:2px solid #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-1mftoz3.svelte-1mftoz3{flex-direction:column}.vote-holder.svelte-1mftoz3.svelte-1mftoz3{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-1mftoz3 img.svelte-1mftoz3{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-1mftoz3.svelte-1mftoz3:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 77, 6, 1487);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$1, 71, 10, 1330);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 69, 6, 1248);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 66, 0, 1159);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	$$self.$$.update = () => {
  		...
  		if ($$self.$$.dirty & /*votes*/ 8) {
  			 $$invalidate(0, currentVotes = votes);
  		}
  	};
