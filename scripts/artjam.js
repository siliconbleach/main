(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-1ee2ltx-style";
  	style.textContent = ".artjam-gallery-container.svelte-1ee2ltx{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;max-width:960px}.artjam-entry.svelte-1ee2ltx{width:100%;max-width:25vw;background:purple;border-radius:0.5rem;padding:0.5rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  // (26:2) {#each contest?.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			button = element("button");
  			t = text(t_value);
  			attr_dev(button, "class", "artjam-entry svelte-1ee2ltx");
  			add_location(button, file$2, 26, 4, 469);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(26:2) {#each contest?.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "artjam-gallery-container svelte-1ee2ltx");
  			add_location(div, file$2, 24, 0, 390);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1ee2ltx-style")) add_css$2();
