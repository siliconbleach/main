(function () {
  ...
  function add_css() {
  	...
  	style.textContent = ".vote-container.svelte-1j3wdui{display:flex;position:fixed;bottom:8px;left:8px}.vote-holder.svelte-1j3wdui{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-1j3wdui{flex-direction:column}.vote-holder.svelte-1j3wdui{margin:8px auto}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			add_location(span, file, 52, 6, 861);
  			attr_dev(div, "class", "vote-holder svelte-1j3wdui");
  			add_location(div, file, 51, 4, 829);
  		},
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file, 49, 0, 772);
  		},
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	let { votes = Array(5).map(_ => INITIAL_VOTE) } = $$props;
  	console.log(votes);
  	...
  	$$self.$$.update = () => {
  		if ($$self.$$.dirty & /*user, votes*/ 3) {
  			 $$invalidate(0, votes = user?.votes?.map((vote, i) => {
  ...
  class App extends SvelteComponentDev {
  	constructor(options) {
  		...
  		init(this, options, instance, create_fragment, safe_not_equal, { user: 1, votes: 0 });
