(function () {
  ...
  function add_css$1() {
  	var style = element("style");
  	style.id = "svelte-er6abo-style";
  	style.textContent = ".vote-container.svelte-er6abo.svelte-er6abo{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-er6abo.svelte-er6abo{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-er6abo.svelte-er6abo{flex-direction:column}.vote-holder.svelte-er6abo.svelte-er6abo{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-er6abo img.svelte-er6abo{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 66, 6, 1175);
  		},
  		m: function mount(target, anchor) {
  ...
  // (60:2) {#each votes as vote}
  function create_each_block(ctx) {
  	let div;
  	let t0_value = /*vote*/ ctx[4]?.piece_id + "";
  	let t0;
  	let t1;
  	let img;
  	let img_src_value;
  	...
  	const block = {
  		c: function create() {
  			...
  			t1 = space();
  			img = element("img");
  			if (img.src !== (img_src_value = `${CDN_BASE_URL}/${/*vote*/ ctx[4].piece_id}.jpg`)) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "alt", "Artjam entry vote thumbnail");
  			attr_dev(img, "class", "svelte-er6abo");
  			add_location(img, file$1, 63, 4, 1060);
  			attr_dev(div, "class", "vote-holder svelte-er6abo");
  			add_location(div, file$1, 61, 3, 1010);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*votes*/ 1 && t0_value !== (t0_value = /*vote*/ ctx[4]?.piece_id + "")) set_data_dev(t0, t0_value);

  			if (dirty & /*votes*/ 1 && img.src !== (img_src_value = `${CDN_BASE_URL}/${/*vote*/ ctx[4].piece_id}.jpg`)) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(60:2) {#each votes as vote}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "vote-container svelte-er6abo");
  			add_location(div, file$1, 57, 0, 952);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class VoteManager extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-er6abo-style")) add_css$1();
