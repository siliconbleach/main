(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-sgo7hc-style";
  	style.textContent = ".artjam-gallery-container.svelte-sgo7hc{display:flex;justify-content:space-between;flex-wrap:wrap;align-items:center;max-width:960px}.artjam-entry.svelte-sgo7hc{width:100%;max-width:23vw;background-color:lightslategray;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  // (27:2) {#each contest?.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			button = element("button");
  			t = text(t_value);
  			attr_dev(button, "class", "artjam-entry svelte-sgo7hc");
  			add_location(button, file$2, 27, 4, 506);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(27:2) {#each contest?.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "artjam-gallery-container svelte-sgo7hc");
  			add_location(div, file$2, 25, 0, 427);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-sgo7hc-style")) add_css$2();
