(function () {
  ...
  function add_css$2() {
  	var style = element("style");
  	style.id = "svelte-1fddloe-style";
  	style.textContent = ".artjam-gallery-container.svelte-1fddloe{display:grid;grid-template-columns:49vw 49vw;margin:0 auto;width:100%}.artjam-entry.svelte-1fddloe{display:flex;width:100%;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto}@media all and (min-width: 960px){.artjam-gallery-container.svelte-1fddloe{max-width:960px}.artjam-entry.svelte-1fddloe{max-width:23vw}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(46:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (47:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			attr_dev(button, "class", "artjam-entry svelte-1fddloe");
  			add_location(button, file$2, 47, 6, 927);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(47:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			div = element("div");
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-1fddloe");
  			add_location(div, file$2, 44, 0, 821);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1fddloe-style")) add_css$2();
