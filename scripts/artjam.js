(function () {
  ...
  function add_css() {
  	...
  	style.id = "svelte-1kp9uvt-style";
  	style.textContent = "#vote-submission.svelte-1kp9uvt{position:fixed;left:5.5rem;bottom:0.75rem;display:flex;justify-content:center;align-items:center}#submitvotes-button.svelte-1kp9uvt{background:rgba(0, 0, 0, 0.6);appearance:none;border:none;padding:0.75rem;color:#fff;border-radius:0.25rem;font-size:20px;opacity:0;visibility:hidden;transition:all 0.75s ease-in-out}#submitvotes-button.is-shown.svelte-1kp9uvt{opacity:1;visibility:visible}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  ...
  class FloatingSubmitButton extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-1kp9uvt-style")) add_css();
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 91, 11, 1867);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(img, "srcset", img_srcset_value = `${CDN_BASE_URL}/${/*vote*/ ctx[10].piece_id || /*vote*/ ctx[10].id}.png`);
  		...
  		p: function update(ctx, dirty) {
  			...
  			if (dirty & /*currentVotes*/ 2 && img_srcset_value !== (img_srcset_value = `${CDN_BASE_URL}/${/*vote*/ ctx[10].piece_id || /*vote*/ ctx[10].id}.png`)) {
  ...
  function add_css$3() {
  	var style = element("style");
  	style.id = "svelte-zbfe7f-style";
  	style.textContent = ".artjam-gallery-container.svelte-zbfe7f{display:grid;grid-template-columns:49vw 49vw;margin:0 auto;width:100%;position:relative;z-index:9998}.artjam-entry.svelte-zbfe7f{display:flex;width:100%;height:20vh;max-width:49vw;background-color:lightslategray;color:white;border:1px solid transparent;border-radius:0.5rem;padding:0.5rem;margin:1rem auto;position:relative}.artjam-vote.svelte-zbfe7f{position:absolute;bottom:1rem;right:1rem;border-radius:0.25rem;width:3rem;height:2rem;background:rgba(255, 255, 255, 0.25);border:none}@media all and (min-width: 960px){.artjam-gallery-container.svelte-zbfe7f{grid-template-columns:repeat(4, 23vw);grid-column-gap:1vw;max-width:960px}.artjam-entry.svelte-zbfe7f{max-width:23vw}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(73:2) {#if contest.entries}",
  		ctx
  	});
  ...
  // (74:4) {#each contest.entries as entry}
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t3 = space();
  			attr_dev(button0, "class", "artjam-vote svelte-zbfe7f");
  			add_location(button0, file$3, 77, 8, 1688);
  			attr_dev(button1, "class", "artjam-entry svelte-zbfe7f");
  			add_location(button1, file$3, 74, 6, 1591);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(74:4) {#each contest.entries as entry}",
  		ctx
  	});
  ...
  function create_fragment$3(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t = space();
  			if (if_block) if_block.c();
  			attr_dev(div, "class", "artjam-gallery-container svelte-zbfe7f");
  			add_location(div, file$3, 70, 0, 1450);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  class ContestGallery extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-zbfe7f-style")) add_css$3();
