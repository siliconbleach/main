(function () {
  ...
  function add_css$1() {
  	...
  	style.textContent = ".vote-container.svelte-66ywdh.svelte-66ywdh{position:fixed;bottom:8px;left:8px;display:flex;flex-direction:row}.vote-holder.svelte-66ywdh.svelte-66ywdh{width:64px;height:64px;border:2px inset #fff;border-radius:6px;margin:0 8px}@media screen and (min-width: 768px){.vote-container.svelte-66ywdh.svelte-66ywdh{flex-direction:column}.vote-holder.svelte-66ywdh.svelte-66ywdh{margin:0.5rem auto;position:relative;overflow:hidden}.vote-holder.svelte-66ywdh img.svelte-66ywdh{position:absolute;top:0;left:0;width:100%;height:auto;max-height:100%}img.svelte-66ywdh.svelte-66ywdh:hover{cursor:pointer}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  	append_dev(document.head, style);
  }
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*clearVote, currentVotes, CDN_BASE_URL*/ 1) {
  				each_value = currentVotes;
  				validate_each_argument(each_value);
  				let i;
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file$1, 77, 6, 1540);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(img, file$1, 71, 10, 1383);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 69, 6, 1301);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "click", /*clearVote*/ ctx[0](/*vote*/ ctx[6]), false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(new_ctx, dirty) {
  			ctx = new_ctx;
  			if (/*vote*/ ctx[6]) if_block.p(ctx, dirty);
  		},
  		d: function destroy(detaching) {
  ...
  function create_fragment$1(ctx) {
  	...
  	let mounted;
  	let dispose;
  	let if_block = currentVotes && create_if_block(ctx);
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 66, 0, 1183);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		...
  		p: function update(ctx, [dirty]) {
  			if (currentVotes) if_block.p(ctx, dirty);
  			debugger;
  		},
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	const clearVote = index => {
  		...
  		$$invalidate(2, votes = currentVotes);
  	};
  	...
  	$$self.$inject_state = $$new_props => {
  		...
  		if ("votes" in $$props) $$invalidate(2, votes = $$new_props.votes);
  		if ("offset" in $$props) $$invalidate(3, offset = $$new_props.offset);
  	};
  	...
  	$$self.$$.update = () => {
  		 $$invalidate(2, votes = $$props.user.votes);

  		if ($$self.$$.dirty & /*votes*/ 4) {
  			 $$invalidate(3, offset = Array(5 - votes.length));
  		}

  		if ($$self.$$.dirty & /*votes, offset*/ 12) {
  			  votes.concat(offset);
  		}
  	};

  	$$props = exclude_internal_props($$props);
  	return [clearVote, user];
  }
