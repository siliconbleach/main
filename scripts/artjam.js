  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			add_location(span, file, 44, 6, 775);
  			attr_dev(div, "class", "vote-holder svelte-1j3wdui");
  			add_location(div, file, 43, 4, 743);
  		},
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file, 41, 0, 686);
  		},
