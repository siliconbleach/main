(function () {
  ...
  function add_css() {
  	...
  	style.id = "svelte-10gbtqq-style";
  	style.textContent = "#submitvotes-button.svelte-10gbtqq{background:rgba(0, 0, 0, 0.6);appearance:none;border:none;padding:0.75rem;color:#fff;border-radius:0.25rem;font-size:20px;position:fixed;bottom:24px;z-index:111111111110;left:25%;right:25%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t = text("Submit Votes\n    ");
  			span = element("span");
  			add_location(span, file, 27, 4, 513);
  			attr_dev(button, "id", "submitvotes-button");
  			attr_dev(button, "class", "svelte-10gbtqq");
  			add_location(button, file, 25, 2, 459);
  			add_location(form, file, 24, 0, 450);
  		},
  ...
  class FloatingSubmitButton extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		if (!document.getElementById("svelte-10gbtqq-style")) add_css();
